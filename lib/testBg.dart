...
class testBg extends StatefulWidget {
  testBg({Key key}) : super(key: key);
  @override
  _testBgState createState() => _testBgState();
}

class _testBgState extends State<testBg> with TickerProviderStateMixin {
    ...
    return Scaffold(
        ...
        body: Form(
          ...
          _curvedBackContainer(
              Color(0XFF2a2a2a),
              curvedBackgroundTopPosition - 10,
              curvedBackgroundLeftPosition - 2),
          _curvedBackContainer(Color(0XFF232323), curvedBackgroundTopPosition,
              curvedBackgroundLeftPosition),
  ...
  _buildFormButton() {
    ...
    return AnimatedBuilder(
        ...
        builder: (context, child) {
          return Transform(
              transform: Matrix4.translationValues(
                  _buttonSlideAnimation.value * 100.0, 0, 0),
              child: Container(
                  height: buttonWidth,
                  width: buttonWidth,
                  child: FittedBox(
