...
class FirstTypeRegistration extends StatefulWidget {
  _FirstTypeRegistrationState createState() => _FirstTypeRegistrationState();
}

class _FirstTypeRegistrationState extends State<FirstTypeRegistration> {
          ...
          child: Container(
            child: ListView(
              children: <Widget>[
                ...
                //   child: Stack(
                //     children: <Widget>[
                //       Positioned(left: 10, top: 10, child: new Text("")
                //           // IconButton(
                //           //   onPressed: () {
                ...
                SingleChildScrollView(
                  child: Column(
                    children: <Widget>[
                      ...
                      Padding(
                        padding: EdgeInsets.only(bottom: 12),
                        child: _input(Icon(Icons.location_city_rounded),
                            "المدينة", _cityController, true),
                      ),
                      Padding(
                        padding: EdgeInsets.only(bottom: 12),
                      ...
                      Padding(
                        padding: EdgeInsets.only(bottom: 12),
                        child: _input(Icon(Icons.mobile_friendly),
                            "رقم مسؤول الدار", _mobileNoController, true),
                      ),
                      Padding(
                        padding: EdgeInsets.only(bottom: 12),
